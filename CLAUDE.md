...
This project is indexed by GitNexus as **template** (502 symbols, 819 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
